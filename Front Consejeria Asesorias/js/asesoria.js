...
function rellenarAsesorJuicio() {
    fetch('http://200.58.127.244:3009/asesores', {
        method: 'GET',
        headers: {
    ...
    fetch('http://200.58.127.244:3009/tipos-de-juicio', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function generosEstados() {
    ...
    fetch('http://200.58.127.244:3009/generos', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
    ...
    fetch('http://200.58.127.244:3009/estados-civiles', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function motivoSelect() {
    ...
    fetch('http://200.58.127.244:3009/motivos', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function validarCodigoPostal() {
    ...
    fetch(`http://200.58.127.244:3012/codigospostales/cp/${codigoPostal}`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
        ...
        .then(data => {
            ...
            document.getElementById('txtEstadoIT2').value = data.data.estado.nombre_estado;
            document.getElementById('txtMunicipioIT2').value = data.data.municipio.nombre_municipio;
            document.getElementById('txtCiudadIT2').value = data.data.ciudad.nombre_ciudad;
            ...
            data.data.colonias.forEach(colonia => {
                const option = document.createElement('option');
...
function registarAsesoria() {
    ...
    fetch('http://200.58.127.244:3009/asesorias', options)
        .then(response => response.json())
        .then(data => {
