...
function buscarAsesoria() {
    ...
    if (nombre === "" || apellidoPaterno === "" || apellidoMaterno === "") {
        ...
        const url = `http://200.58.127.244:3009/asesorias/buscar?nombre=${encodeURIComponent(nombre)}&apellido_paterno=${encodeURIComponent(apellidoPaterno)}&apellido_materno=${encodeURIComponent(apellidoMaterno)}`;
        ...
        fetch(url, opciones)
            ...
            .then(data => {
                ...
                if (asesoria) {
                    ...
                    fetch(`http://200.58.127.244:3012/colonias/${idColonia}`, {
                        method: 'GET',
                        headers: {
